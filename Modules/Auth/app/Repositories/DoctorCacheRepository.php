...
class DoctorCacheRepository implements DoctorRepositoryInterface
{
    ...
    public function __construct(DoctorRepositoryInterface $repository, CacheRepository $cache)
    {
